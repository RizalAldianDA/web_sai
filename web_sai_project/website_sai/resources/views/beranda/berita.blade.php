    ...
    <body>
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <div class="dropdown">
                                        ...
                                        <a class="active" href="{{ route('beranda.berita')}}">BERITA</a>
        ...
        <div class="content">
            <div class="container-content">
                <div class="halaman">
                    <h6><a href="{{ route('beranda.data')}}">Beranda</a>&nbsp&nbsp<i class="fa fa-caret-right" style="color: #d0343c"></i>&nbsp&nbsp<span class="this">Berita</span></h6>
                </div>
                <h6 class="tipe-judul1">Tipe :</h6>
                <h3 class="tipe-judul2">Berita</h3>
