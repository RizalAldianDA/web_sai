...
<html lang="en">
    <head>
        ...
        <style>
          ...
          .container-content .pure-g .pure-u-md-1-1{
    ...
    <body>
                    ...
                    <div class="botnav-right">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent2">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <div class="dropdown">
                                        <button class="dropbtn dropbtn-active" style="background-color: #B22222">KATEGORI <i class="fa fa-caret-down"></i></button>
                                        <div class="dropdown-content">
                                        <a href="{{ route('beranda.artikel')}}">ARTIKEL</a>
                                        <a href="{{ route('beranda.berita')}}">BERITA</a>
                                        <a class="active" href="{{ route('beranda.rekuit')}}">RECRUITMENT</a>
                                        </div>
                                    </div>
                                </li>
                                <li class="nav-item">
        ...
        <div class="content">
            <div class="container-content">
                <div class="halaman">
                    <h6><a href="{{ route('beranda.data')}}">Beranda</a>&nbsp&nbsp<i class="fa fa-caret-right" style="color: #d0343c"></i>&nbsp&nbsp<span class="this">Recruitment</span></h6>
                </div>
                <h6 class="tipe-judul1">Tipe :</h6>
                <h3 class="tipe-judul2">Recruitment</h3>

                @forelse ($rekuit as $info)
                    <div class="pure-g">
                        <div class="l-box pure-u-1 pure-u-lg-1-5 pure-u-md-1-1">
                            <a href="{{ route('beranda.info',['info' => $info->id]) }}"><img width="50%" height="50%" src="{{ url('') }}/{{$info->image}}" alt=""></a>
                        </div>
                        <div class="l-box pure-u-1 pure-u-lg-3-5 pure-u-md-1-1">
                            <a href="{{ route('beranda.info',['info' => $info->id]) }}"><h5 class="judul">{{$info->judul_info}}</h5></a>
                            <h6 class="tipe">{{$info->jenis}}&nbsp{{$info->day}}</h6>
                            <pre>{{$info->keterangan}}</pre>
                        </div>
                        <div class="l-box pure-u-1 pure-u-lg-1-5">
                        </div> 
                    </div>
                @empty
                <style>
