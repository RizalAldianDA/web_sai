    ...
    <body>
        ...
        <div class="content">
            <div class="container-content">
                <div class="halaman">
                    <h6><a href="{{ route('beranda.data')}}">Beranda</a>&nbsp&nbsp<i class="fa fa-caret-right" style="color:#33333"></i>&nbsp
                        @if ($info->jenis=='Artikel')
                            <a href="{{ route('beranda.artikel')}}">
                        @elseif($info->jenis=='Berita')
                            <a href="{{ route('beranda.berita')}}">
                        @elseif($info->jenis=='Recruitment')
                            <a href="{{ route('beranda.rekuit')}}">
                        @endif
                        {{$info->jenis}}</a>&nbsp&nbsp<i class="fa fa-caret-right" style="color: #d0343c"></i>&nbsp&nbsp<span class="this">{{$info->judul_info}}</span></h6>
                </div>
                <div class="pure-g">
                    <div class="l-box pure-u-1 pure-u-lg-1-1 pure-u-md-1-1">
                        <h5 class="judul">{{$info->judul_info}}</h5>
                        <h6 class="tipe">{{$info->jenis}}&nbsp{{$info->day}}&nbsp{{$info->publisher}}</h6>
                    </div>
                    <div class="l-box pure-u-1 pure-u-lg-1-1 pure-u-md-1-1">
