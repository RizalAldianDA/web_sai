    ...
    <body>
        ...
        <div class="content">
            <div class="container-content">
                <div class="halaman">
                    <h6><a href="{{ route('beranda.data')}}">Beranda</a>&nbsp&nbsp<i class="fa fa-caret-right" style="color: #d0343c"></i>&nbsp&nbsp<span class="this">Hasil Pencarian</span></h6>
                </div>
                <h6 class="tipe-judul1">HASIL PENCARIAN UNTUK</h6>
                <h5 class="tipe-judul2">{{$word}}</h5>
                
                
                    
                @forelse ($cari as $info)
                    <div class="pure-g">
                ...
                <h6>MAAF KEYWORD TIDAK DITEMUKAN</h6>
                @endforelse 
                {{ $cari->links() }}              
            </div> 
        </div>
