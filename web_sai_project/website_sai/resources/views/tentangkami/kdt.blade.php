    ...
    <body>
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <div class="dropdown">
                                        ...
                                        <a class="active" href="{{ route('tentangkami.kdt')}}">KEDUDUKAN DAN TUGAS</a>
                                        </div>
                                    </div>  
                                </li>
        ...
        <div class="content">
            <div class="container-content">
                <div class="halaman">
                    <h6><a href="{{ route('beranda.data')}}">Beranda</a>&nbsp&nbsp<i class="fa fa-caret-right" style="color: #d0343c"></i><span class="this">&nbsp&nbspKedudukan dan Tugas</span></h6>
                </div>
