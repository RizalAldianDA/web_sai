    ...
    <body>
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <div class="dropdown">
                                        ...
                                        <a class="active" href="{{ route('tentangkami.vdm')}}">VISI DAN MISI</a>
        ...
        <div class="content">
            <div class="container-content">
                <div class="halaman">
                    <h6><a href="{{ route('beranda.data')}}">Beranda</a>&nbsp&nbsp<i class="fa fa-caret-right" style="color: #d0343c"></i>&nbsp&nbsp<span class="this">Visi dan Misi</span></h6>
                </div>
