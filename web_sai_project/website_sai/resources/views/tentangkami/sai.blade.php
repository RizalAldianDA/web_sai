                    ...
                    <div class="botnav-right">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent2">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <div class="dropdown">
                                        <button class="dropbtn dropbtn-active" style="background-color: #B22222">TENTANG KAMI <i class="fa fa-caret-down"></i></button>
                                        <div class="dropdown-content">
                                        <a class="active" href="{{ route('tentangkami.sai')}}">SATUAN AUDIT INTERNAL</a>
        ...
        <div class="background-img">
            <div class="content">
                <div class="container-content">
                    <div class="halaman">
                        <h6><a href="{{ route('beranda.data')}}">Beranda</a>&nbsp&nbsp<i class="fa fa-caret-right" style="color: #d0343c"></i>&nbsp&nbsp<span class="this">Satuan Audit Internal</span></h6>
                    </div>
