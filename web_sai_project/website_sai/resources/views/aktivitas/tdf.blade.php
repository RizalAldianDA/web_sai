    ...
    <body>
                                ...
                                <li class="nav-item">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-content">
                                            ...
                                            <a class="active" href="{{ route('aktivitas.tdf')}}">TUJUAN DAN FUNGSI</a>
        ...
        <div class="content">
            <div class="container-content">
                <div class="halaman">
                    <h6><a href="{{ route('beranda.data')}}">Beranda</a>&nbsp&nbsp<i class="fa fa-caret-right" style="color: #d0343c"></i><span class="this">&nbsp&nbspTujuan dan Fungsi</span></h6>
                </div>
