    ...
    <body>
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-content">
                                            <a class="active" href="{{ route('aktivitas.kdtj')}}">KEWENANGAN DAN TANGGUNG JAWAB</a>
        ...
        <div class="content">
            <div class="container-content">
                <div class="halaman">
                    <h6><a href="{{ route('beranda.data')}}">Beranda</a>&nbsp&nbsp<i class="fa fa-caret-right" style="color: #d0343c"></i><span class="this">&nbsp&nbspKewenangan dan Tanggung Jawab</span></h6>
                </div>

                @forelse ($kdtj as $info)
                    <div class="pure-g">
