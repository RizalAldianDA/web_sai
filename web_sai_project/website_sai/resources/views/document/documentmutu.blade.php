    ...
    <body>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent2">
                            <ul class="navbar-nav mr-auto">
                                ...
                                @if ($check->document_page=='Up'&&$check->download_page=='Up')
                                    <li class="nav-item">
                                        <a class="active" href="{{ route('document.mutu')}}">DOCUMENT MUTU</a>
                                    </li>
                                    <li class="nav-item">
        ...
        <div class="content">
            <div class="container-content">
                <div class="halaman">
                    <h6><a href="{{ route('beranda.data')}}">Beranda</a>&nbsp&nbsp<i class="fa fa-caret-right" style="color: #d0343c"></i>&nbsp&nbsp<span class="this">Document Mutu</span></h6>
                </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        @forelse ($document as $info)
                            <tr>
                                <th>{{$loop->iteration}}</th>
                                <td>{{$info->nama_file}}</a></td>
                                <td>{{$info->publisher_file}}</td>
                                <td>
                                    <a class="btn btn-primary extra" href="{{ url('') }}/{{$info->file}}" alt="">Download</a>
                                </td>
                            </tr>
                        @empty
                        <style>
                            ...
                            <td colspan="6" class="text-center">Tidak ada file...</td>
                        @endforelse
                    </tbody>
                </table>
