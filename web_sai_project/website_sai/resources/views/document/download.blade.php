    ...
    <body>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent2">
                            <ul class="navbar-nav mr-auto">
                                ...
                                @if ($check->document_page=='Up'&&$check->download_page=='Up')
                                    ...
                                    <li class="nav-item">
                                        <a class="active" href="{{ route('document.download')}}">DOWNLOAD</a>
                                    </li>
        ...
        <div class="content">
            <div class="container-content">
                <div class="halaman">
                    <h6><a href="{{ route('beranda.data')}}">Beranda</a>&nbsp&nbsp<i class="fa fa-caret-right" style="color: #d0343c"></i>&nbsp&nbsp<span class="this">Download</span></h6>
                </div>
